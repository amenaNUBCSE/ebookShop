...
class FeaturedController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        return redirect()->route('featured.index')->with('success', 'Featured section successfully created.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('featured.index')->with('success', 'Featured section successfully updated.');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->route('featured.index')->with('success', 'Featured section successfully removed.');
    }
