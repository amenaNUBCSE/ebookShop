...
//     in admin dashbhoard
    ...
    public function save(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('book.index')->with('success','successfully created book.');
    ...
    public function search2(Request $request):View {
        $categoryelected = null;
        if (isset($request->category)) {
            $categoryelected = Category::findOrFail($request->category);
        }

        $subcategoryelected = null;
        if (isset($request->subcategory)) {
            $subcategoryelected = Subcategory::findOrFail($request->subcategory);
        }
        ...
        return view('book.search',compact('categories','categoryelected','subcategoryelected','books'));
    }
    ...
    public function delete($id): RedirectResponse {
        ...
        return redirect()->route('book.index')->with('success', "Successfully deleted book");
    }

    public function searchSelect(Request $request): JsonResponse
    {
        //        TODO: Revisar el uso que se le esta dando a esta informacion y Remove contenido que sea irrelevante
        $sql = "SELECT
    books.id,
    books.book_isbn,
    books.book_title,
    ...
    {
        $max = 8;   // limite de Books para mostrar
