...
class Subcategoryeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Las obras de literatura clásica son aquellas que han resistido la prueba del tiempo, siendo atemporales en su relevancia y profundidad. Estos Books representan hitos literarios de diferentes épocas, transmitiendo valores universales, explorando la condición humana y ofreciendo una mirada única a la historia y la sociedad de sus períodos.',
        ...
        Subcategory::create( [
            'id'=>8,
            'category_id'=>2,
            'subcategory_name'=>'Books de historia',
            'subcategory_description'=>'Estas obras exploran eventos, periodos y aspectos particulares del pasado. Desde análisis detallados de civilizaciones antiguas hasta acontecimientos históricos más recientes, estos Books ofrecen una comprensión más profunda de cómo evolucionó el mundo en el que vivimos.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Este tipo de Books presenta reflexiones, análisis y evaluaciones sobre diversos temas, ya sea desde una perspectiva académica o personal. Abordan críticas de arte, literatura, sociedad, política o cultura, ofreciendo perspectivas enriquecedoras y provocativas sobre temas de interés.',
        ...
        Subcategory::create( [
            'id'=>10,
            'category_id'=>2,
            'subcategory_name'=>'Books de viajes',
            'subcategory_description'=>'Estas obras relatan experiencias de viaje, aventuras y descubrimientos. Desde guías de viaje hasta narrativas de exploración de distintos lugares y culturas, estos Books inspiran, informan y entretienen, transportando a los lectores a diferentes rincones del mundo.',
        ...
        Subcategory::create( [
            'id'=>11,
            'category_id'=>2,
            'subcategory_name'=>'Books de cocina y gastronomía',
            'subcategory_description'=>'Estos Books ofrecen recetas, historias culinarias, exploran tendencias gastronómicas y enseñan sobre técnicas de cocina. Desde Books de cocina étnica hasta guías de nutrición, estos Books son una fuente de inspiración para los amantes de la comida y la gastronomía.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Estos Books buscan ayudar a los lectores a crecer personalmente, a enfrentar desafíos y a mejorar la calidad de vida. Cubren temas que van desde la gestión del tiempo y el liderazgo hasta técnicas para el manejo del estrés, la superación de obstáculos y el logro de metas.',
        ...
        Subcategory::create( [
            'id'=>13,
            'category_id'=>3,
            'subcategory_name'=>'Books infantiles',
            'subcategory_description'=>'Estos Books están diseñados específicamente para los más pequeños, desde recién nacidos hasta niños de hasta cinco años. Incluyen Books de cartón, Books con ilustraciones coloridas y texturas táctiles para fomentar la interacción y el aprendizaje temprano. Sus historias simples y coloridas imágenes buscan entretener y estimular el desarrollo cognitivo y emocional de los niños pequeños.',
        ...
        Subcategory::create( [
            'id'=>15,
            'category_id'=>3,
            'subcategory_name'=>'Books educativos',
            'subcategory_description'=>'Estos Books están orientados a enseñar y brindar conocimientos a los niños y jóvenes. Pueden abordar una variedad de temas, desde matemáticas y ciencias hasta lenguajes, historia y mucho más. Utilizan métodos interactivos, como ilustraciones llamativas, juegos y actividades, para facilitar el aprendizaje y el desarrollo de habilidades.',
        ...
        Subcategory::create( [
            'id'=>16,
            'category_id'=>3,
            'subcategory_name'=>'Books ilustrados',
            'subcategory_description'=>'Estos Books se caracterizan por tener una combinación de texto e ilustraciones llamativas que narran historias de una manera visualmente atractiva. Están destinados a lectores de diferentes edades y a menudo exploran temas emocionales o complejos a través de ilustraciones impactantes y narrativas simples.',
        ...
        Subcategory::create( [
            'id'=>17,
            'category_id'=>3,
            'subcategory_name'=>'Books de actividades',
            'subcategory_description'=>'Esta subcategoría ofrece Books que proponen actividades prácticas y entretenidas. Desde Books de colorear y juegos de rompecabezas hasta Books de manualidades, buscan mantener entretenidos a los niños y jóvenes mientras estimulan su creatividad, habilidades motoras y pensamiento lógico.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Estos Books están ambientados en mundos imaginarios, repletos de magia, aventuras y elementos fantásticos. Dirigidos a lectores jóvenes, exploran mundos alternativos, viajes en el tiempo, poderes sobrenaturales y otros temas que despiertan la imaginación y la curiosidad.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Enfocada en la vida en la Tierra, esta subcategoría explora la biología en todas sus formas, desde la estructura celular hasta la ecología de los ecosistemas. Los Books incluidos pueden tratar sobre la diversidad de la vida salvaje, la conservación de especies, la evolución y el comportamiento animal.',
        ...
        Subcategory::create( [
            'id'=>23,
            'category_id'=>4,
            'subcategory_name'=>'Books de divulgación científica',
            'subcategory_description'=>'Esta subcategoría busca acercar la ciencia al público en general. Los Books de divulgación científica explican conceptos científicos complejos de manera accesible y entretenida, haciendo que temas complejos sean comprensibles para lectores sin formación científica específica.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta área se centra en la estética y la creatividad en la moda y el diseño. Desde Books que exploran el diseño gráfico hasta las tendencias de la moda a lo largo de la historia, ofrece una comprensión más profunda de cómo la creatividad y el estilo han evolucionado en diferentes contextos culturales.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se sumerge en la historia, los estilos y las innovaciones arquitectónicas. Desde Books que analizan la arquitectura antigua hasta las tendencias modernas, ofrece una perspectiva detallada de los edificios más significativos, los arquitectos Featured y los movimientos que han influenciado la construcción a lo largo del tiempo.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se centra en las artes interpretativas. Desde Books que exploran el teatro y la danza hasta aquellas que analizan las actuaciones y producciones escénicas, ofrece una comprensión más profunda de la expresión artística a través del movimiento y la actuación.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Estas lecturas se centran en enseñar técnicas de mindfulness y meditación para cultivar la atención plena, reducir el estrés y mejorar la salud mental. Los Books en esta subcategoría ofrecen prácticas para estar presentes en el momento y lograr la paz interior.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría abarca Books que proporcionan información sobre la salud física y el bienestar general. Desde guías de ejercicio y nutrición hasta consejos para un estilo de vida más saludable, estos Books buscan ayudar a los lectores a mejorar su bienestar general.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se centra en Books que buscan inspirar, motivar y fomentar la determinación para superar desafíos. Ofrecen historias de éxito, estrategias de motivación y cómo superar obstáculos para alcanzar objetivos personales.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Books que exploran diferentes aspectos de la psicología humana, desde Books introductorios hasta estudios profundos sobre la mente, el comportamiento y la comprensión de las emociones. Estos Books ofrecen ideas sobre el funcionamiento de la mente humana.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría abarca Books que exploran la espiritualidad en sus diversas formas. Desde enseñanzas religiosas hasta prácticas espirituales no religiosas, estos Books ofrecen reflexiones sobre el significado de la vida, la conexión con lo trascendental y la búsqueda de sentido y propósito.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se enfoca en estrategias de marketing y técnicas de ventas efectivas. Los Books en esta área cubren desde conceptos fundamentales hasta las últimas tendencias en publicidad, branding, análisis de mercado y tácticas de ventas para promover Products y servicios.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se enfoca en el desarrollo de habilidades de liderazgo, gestión de equipos y organizaciones. Los Books en esta área exploran estilos de liderazgo, resolución de conflictos, gestión de recursos humanos, motivación de equipos y estrategias para el crecimiento organizacional.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Estos Books se sumergen en los principios fundamentales de la economía y las teorías financieras. Exploran temas como macroeconomía, microeconomía, políticas económicas, teorías financieras y el funcionamiento de los mercados financieros.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría se enfoca en comparar diferentes tradiciones religiosas, identificando similitudes y diferencias entre creencias, prácticas, mitologías y cosmovisiones. Los Books en esta sección exploran la intersección y la diversidad de las principales religiones del mundo, ofreciendo una comprensión más amplia de las diferentes formas de fe.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Aquí se encuentran Books que exploran aspectos más ocultos o misteriosos de las prácticas espirituales. Desde el misticismo de diferentes tradiciones hasta prácticas esotéricas, como la alquimia o la astrología, estos Books ofrecen una visión de los aspectos más profundos y menos conocidos de la espiritualidad.',
        ...
        Subcategory::create( [
            'id'=>46,
            'category_id'=>8,
            'subcategory_name'=>'Books Sagrados',
            'subcategory_description'=>'Esta subcategoría alberga textos considerados sagrados o fundamentales en varias tradiciones religiosas. Desde la Biblia, el Corán, la Torá, los Vedas y otros textos religiosos, estos Books son fundamentales para el estudio y la comprensión de las creencias y prácticas religiosas.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Los Books de teología exploran y discuten conceptos doctrinales, teológicos y dogmas dentro de las diferentes tradiciones religiosas. Estos textos examinan la naturaleza de la fe, la divinidad, la salvación y otros aspectos teológicos fundamentales de diversas religiones.',
        ...
        Subcategory::create( [
            ...
            'subcategory_description'=>'Esta subcategoría incluye Books que ofrecen inspiración, motivación y reflexiones sobre la espiritualidad. Desde escritos contemporáneos hasta clásicos atemporales, estos Books brindan mensajes de esperanza, consuelo y guía espiritual para los lectores.',
