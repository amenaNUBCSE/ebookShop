...
Route::get('/cart/add/{productId}', [ShoppingCartController::class, 'addToCart'])->name('cart.add');
...
Route::middleware('UserAdmin')->group(function () {
    ...
    Route::get('/book/search/{search}', [BookController::class, 'searchSelect'])->name('book.searchSelect');    // TODO: cambiar el Number de esta ruta
