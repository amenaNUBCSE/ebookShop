                        ...
                        <div class="card-body pb-2">
                                ...
                                <div class="col-md-12">
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('author_name')) >= 1)
                                            <input value="{{$author->author_name}}" name="author_name" id="author_name"
                                                   class="form-control" placeholder="Number del autor"
                            ...
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <a href="{{route('author.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Cancel
                                    </a>
                                </div>
