...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Ver Editorial</h2>
                ...
                <div class="card d-flex justify-content-center p-4 shadow-lg">
                    ...
                    <div class="card-body pb-2">
                        <div class="col-lg-12">
                            ...
                            <div class="display-4 text-md">Created el {{$publisher->created_at}} y ultima vez Updated el {{$publisher->updated_at}}</div>
                        </div>
{{--                        <div class="row">--}}
{{--                            <div class="col-lg-12">--}}
...
{{--                                                <span data-bs-toggle="tooltip" data-bs-placement="left" title="Esta Subcategory tiene 0 Books" class="badge bg-gradient-wwarning">0</span>--}}
{{--                                            </li>--}}
...
{{--                        </div>--}}
                        ...
                        <div class="row">
                            <div class="col-md-12 text-start">
                                <a href="{{route('publisher.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Return
                                </a>
                            </div>
