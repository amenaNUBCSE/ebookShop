...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Edit Subcategory</h2>
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('subcategory_description')) >= 1)
                                    <textarea name="subcategory_description" class="form-control"
                                              ...
                                              placeholder="Una descripcion breve de la Subcategory" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{$subcategory->subcategory_description}}</textarea>
                                @else
                                    <textarea name="subcategory_description" class="form-control"
                                              id="subcategory_description" rows="6"
                                              placeholder="Una descripcion breve de la Subcategory">{{$subcategory->subcategory_description}}</textarea>
                                @endif
                            </div>
                            <x-input-error class="text-danger"
