            ...
            <div class="row">
                ...
                <div class="col" style="text-align: end; max-width: fit-content;">
                    @if(count($categories) > 0)
                        <a href="{{route('subcategory.create')}}" class="btn btn-sm btn-warning">Create Subcategory</a>
                    @else
                        <a type="button" class="btn btn-sm btn-secondary" data-bs-toggle="tooltip"
                           data-bs-placement="bottom" title="Es necesario Create al menos una categoria primero"
                           data-container="body" data-animation="true"
                           style="box-shadow: 0 3px 3px 0 rgb(0 0 0 / 15%), 0 3px 1px -2px rgb(146 146 146 / 20%), 0 1px 5px 0 rgb(0 0 0 / 15%); cursor: not-allowed !important;">create
                            Subcategory</a>
                    @endif
                                    ...
                                    <button class="accordion-button border-bottom font-weight-bold" type="button"
                                        ...
                                        <div class="row" style="display: contents">
                                            ...
                                            <div class="col-6 text-end">
                                                <span data-bs-toggle="tooltip" data-bs-placement="left" title="Esta Subcategory tiene {{count($category->subcategories)}} Subcategories asociadas" class="badge bg-gradient-warning">{{count($category->subcategories)}}</span>
                                            </div>
                                        </div>
