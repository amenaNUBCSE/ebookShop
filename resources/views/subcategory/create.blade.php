                                    ...
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('subcategory_name')) >= 1)
                                            <input name="subcategory_name" id="subcategory_name" class="form-control"
                                                   placeholder="Number de la Subcategory" aria-label="Full Name"
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('subcategory_description')) >= 1)
                                    <textarea name="subcategory_description" class="form-control"
                                              ...
                                              placeholder="Una descripcion breve de la Subcategory" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{app('request')->old('subcategory_description', null)}}</textarea>
                                @else
                                    <textarea name="subcategory_description" class="form-control"
                                              id="subcategory_description" rows="6"
                                              placeholder="Una descripcion breve de la Subcategory">{{app('request')->old('subcategory_description', null)}}</textarea>
                                @endif
                            ...
                            <div class="row">
                                <div class="col-sm-6 text-start">
                                    <a href="{{route('subcategory.index')}}" class="btn bg-gradient-danger mt-3 mb-0"
                                       style="max-width: 233px; width: -webkit-fill-available;">Cancel
                                    </a>
                                </div>

                                <div class="col-sm-6 text-end">
                                    <button type="submit" class="btn bg-gradient-warning mt-3 mb-0"
                                            style="max-width: 233px;width: -webkit-fill-available;">create
                                    </button>
                                </div>
                            </div>
                        </div>
