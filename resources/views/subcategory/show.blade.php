...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Ver Subcategory</h2>
            ...
            <div class="card">
                ...
                <div class="card d-flex justify-content-center p-4 shadow-lg">
                        ...
                        <div class="card-body pb-2">
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="display-4 text-md">Created el {{$subcategory->created_at}} y ultima vez Updated el {{$subcategory->updated_at}}</div>
                                    </div>
                            ...
                            <div class="row">
{{--                                <div class="col-lg-12">--}}
{{--                                    <p class="display-4" style="font-size: x-large"> Esta Subcategory esta asociada la categoria {{$category->category_name}}</p>--}}
{{--                                </div>--}}
                            </div>
                            <div class="row">
                                <div class="col-md-12 text-start">
                                    <a href="{{route('subcategory.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Return
                                    </a>
                                </div>
