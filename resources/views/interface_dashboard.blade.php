                ...
                <a href="{{ route('featured.index') }}">
                    <div class="card move-on-hover" style="height: 100%">
                        <div class="card-body text-center">
                            ...
                            <h6 class="mb-0 font-weight-bolder">Featured Books</h6>
                        </div>
                    </div>
                </a>
...
<!--                        <div class="card-body text-center">-->
<!--                            <h1 class="text-gradient text-warning"><span id="status1"> COUNT   </span>-->
<!--                            </h1>-->
...
<!--                    <div class="card move-on-hover">-->
<!--                        <div class="card-body text-center">-->
<!--                            <h1 class="text-gradient text-warning"><span id="status1" > COUNT </span></h1>-->
