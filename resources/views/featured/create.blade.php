...
<head>
    <title>Create outstanding</title>
    <!-- Required meta tags -->
    <meta charset="UTF-8">
...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Create outstanding</h2>
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('featured_type_description')) >= 1)
                                    <textarea name="featured_type_description" class="form-control" id="featured_type_description"
                                              rows="6"
                                              placeholder="Una descripción breve de la sección de Featured"
                                ...
                                @else
                                    <textarea name="featured_type_description" class="form-control" id="featured_type_description"
                                              rows="6"
                                              placeholder="Una descripción breve de la sección de Featured">{{app('request')->old('featured_type_description', null)}}</textarea>
                                @endif
                            </div>
                            <x-input-error class="text-danger"
