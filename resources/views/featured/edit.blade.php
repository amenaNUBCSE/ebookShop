...
<!-- TODO: continuar trabajando en el modulo de Featured -->
...
<div style="" class="card card-body shadow-xl mt-n12 mx-3 mx-md-4">
    ...
    <div class="container">
        <div class="section text-left my-4">
            ...
            <h2 class="title">Edit Featured</h2>
                        ...
                        <div class="card-body pb-2">
                                    ...
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('category_name')) >= 1)
                                            <input value="{{featured->featured_type_name}}" name="featured_type_name"
                                                   ...
                                                   placeholder="Number de la sección destacada" aria-label="Full Name"
                                                   type="text"
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('featured_name_description')) >= 1)
                                    <textarea name="featured_type_description" class="form-control" id="featured_type_description"
                                              rows="6"
                                              placeholder="Una descripcion breve de la sección de Featured" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{$featured->featured_type_description}}</textarea>
                                @else
                                    <textarea name="featured_type_description" class="form-control" id="featured_type_description"
                                              rows="6"
                                              placeholder="Una descripcion breve de la sección de Featured">{{$featured->featured_type_description}}</textarea>
                                @endif
                            </div>
                            <x-input-error class="text-danger"
                            ...
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <a href="{{route('featured.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Cancel
                                    </a>
                                </div>
