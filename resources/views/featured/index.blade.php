    ...
    <div class="container">
        <div class="section text-left my-4">
            <div class="row">
                ...
                <div class="col" style="text-align: end"><a href="{{ route('featured.create') }}" class="btn btn-sm btn-warning">Create tipo</a></div>
            </div>
                                        ...
                                        <div class="modal-dialog" style="margin-top: 10rem;">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Esta seguro que desea Remove la seccion de Books Featured
