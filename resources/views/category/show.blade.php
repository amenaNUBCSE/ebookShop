                    ...
                    <div class="card-body pb-2">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="display-4 text-md">Created el {{$category->created_at}} y última vez
                                    Updated el {{$category->updated_at}}</div><br>
                                                ...
                                                @foreach($category->subcategories as $subcategory)
                                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span data-bs-toggle="tooltip" data-bs-placement="left"
                                                              title="Esta Subcategory tiene {{count($subcategory->books)}} Books"
                        ...
                        <div class="row">
                            <div class="col-md-12 text-start">
                                <a href="{{route('category.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Return
                                </a>
                            </div>
