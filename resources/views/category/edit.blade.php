                        ...
                        <div class="card-body pb-2">
                                    ...
                                    <div class="input-group input-group-static mb-4">
                                        ...
                                        @if(count($errors->get('category_name')) >= 1)
                                            <input value="{{$category->category_name}}" name="category_name"
                                                   ...
                                                   placeholder="Number de la category" aria-label="Full Name"
                                                   type="text"
                            ...
                            <div class="input-group input-group-static mb-0 mt-md-0 mt-4">
                                ...
                                @if(count($errors->get('category_description')) >= 1)
                                    <textarea name="category_description" class="form-control" id="category_description"
                                              rows="6"
                                              placeholder="Una descripcion breve de la category" style="box-shadow: 0 0 8px 2px #ff000061; border-radius: 10px !important;">{{$category->category_description}}</textarea>
                                @else
                                    <textarea name="category_description" class="form-control" id="category_description"
                                              rows="6"
                                              placeholder="Una descripcion breve de la category">{{$category->category_description}}</textarea>
                                @endif
                            </div>
                            <x-input-error class="text-danger"
                                        ...
                                        <div class="col mb-4 text-center" style="min-width: 50%">
                                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2"
                                                ...
                                                <img id="category_img" class="border-radius-lg w-50"
                                                     src="{{asset($category->category_image_url)}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 text-start">
                                    <a href="{{route('category.index')}}" class="btn bg-gradient-danger mt-3 mb-0">Cancel
                                    </a>
                                </div>
