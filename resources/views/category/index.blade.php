        ...
        <div class="section text-left my-4">
            <div class="row">
                ...
                <div class="col" style="text-align: end"><a href="{{route('category.create')}}"
                                                            class="btn btn-sm btn-warning">Create category</a></div>
            </div>
                                        ...
                                        <div class="modal-dialog" style="margin-top: 10rem;">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Esta seguro que desea Remove la categoria
                                                    '{{ $category->category_name }}' ?
                                                    <br><br>
                                                    Esta accion es irreversible y podria afectar a todos los Books
