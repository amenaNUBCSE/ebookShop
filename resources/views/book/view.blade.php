            ...
            <div class="row flex-row">
                ...
                <div class="col-lg-7">
                    <div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-3">
                                <a class="btn bg-gradient-faded-white mb-0 mt-lg-auto w-100" href="{{route('home')}}" class="btn bg-gradient-faded-secondary" style="max-width: 233px; width: -webkit-fill-available;">Return
                                </a>
                            </div>

                            <div class="col-md-3">
                                <a class="btn bg-gradient-warning mb-0 mt-lg-auto w-100" href="{{route('cart.add',[$book->id])}}" class="btn bg-gradient-faded-secondary" style="max-width: 233px; width: -webkit-fill-available;">Buy
                                    <svg style="margin-left: 1rem" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
