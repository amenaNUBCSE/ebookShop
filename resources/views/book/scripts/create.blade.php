<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        var categoryelect = document.getElementById("category_id");
        var subcategoryelect = document.getElementById("subcategory_id");
...
// Function for updating subcategory options
        function updateSubcategories() {
            var selectedCategory = categoryelect.value;
            subcategoryelect.innerHTML = ""; // Clear existing options
            ...
            if (subcategoryOptions[selectedCategory]) {
                subcategoryOptions[selectedCategory].forEach(subcategory => {
                    ...
                    subcategoryelect.appendChild(option);
                });
            }
        }
...
// Add a change event to the first select (category)
        categoryelect.addEventListener("change", updateSubcategories);
