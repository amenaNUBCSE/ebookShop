        ...
        <div class="collapse bg-white navbar-collapse w-100 pt-3 pb-2 py-lg-0 ps-lg-5" id="navigation"
            ...
            <ul class="navbar-nav navbar-nav-hover">
                ...
                <li class="nav-item mx-2">
                    <a href="{{route('book.search')}}" class="nav-link ps-2 d-flex cursor-pointer align-items-center">
                        ...
                        <div class="container mr-1 mt-1 ml-1 mb-1">
                            <div class="input-group input-group-dynamic is-filled">
                                ...
                                <input id="searchNav" name="searchNav" type="text" class="form-control"
                                       placeholder="Search Book" aria-label="Libro" aria-describedby="basic-addon1">
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="d-none d-lg-block">
                            @if(Auth::user()->role->role_name == 'admin')
                                ...
                                <a href="{{ route('category.index') }}" class="dropdown-item border-radius-md">
                                    <span>Category</span>
                                </a>
                                <a href="{{ route('subcategory.index') }}" class="dropdown-item border-radius-md">
                                    <span>SubCategory</span>
                                </a>
                                <a href="{{ route('author.index') }}" class="dropdown-item border-radius-md">
                                    <span>Author</span>
                                </a>
                                <a href="{{ route('publisher.index') }}" class="dropdown-item border-radius-md">
                                    <span>Publisher</span>
                                </a>
