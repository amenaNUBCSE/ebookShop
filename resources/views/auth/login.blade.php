                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login') }}" role="form" class="text-start">
                            ...
                            <div class="input-group input-group-outline my-3">
                                ...
                                <input name="email" type="email" value="{{old('email','admin@gmail.com')}}" class="form-control">
                            </div>
                            <div class="input-group input-group-outline mb-3">
                                <label class="form-label">password</label>
                                <input name="password" type="password" value="{{old('password','admin')}}" class="form-control">
                            </div>
                            <div class="text-center">
                                <button type="submit" class="btn bg-gradient-warning w-100 my-1">Login</button>
                            </div>
                            ...
                            <p class="mt-4 text-sm text-center">
                                Don't have an Account?  <a href="{{route('register')}}" class="text-warning">Create one</a>
                            </p>
                        </form>
                    </div>
                </div>
